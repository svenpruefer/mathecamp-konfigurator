...
from mathecamp_konfigurator.model.association import interests, parentsEmail, emergencyNumbers, musicians, sickPeople
from mathecamp_konfigurator.model.association import friendships, gradePreferences
